                    ...
                    "content": [
                        {
                            ...
                            "text": (
                                ...
                                "экономия времени, сокращение затрат, устранение рутины, повышение эффективности, но без "
                                "громких или неподтверждённых обещаний. Письмо должно быть лаконичным: примерно 90-140 слов, "
                                "без длинных списков и перегруженных объяснений. "
                                ...
                                "3) Очень короткое и естественное упоминание, чем занимается компания: 1-2 предложения максимум, без перегруженного перечисления всех услуг. Добавь одно короткое наблюдение о сильной стороне компании.\n"
                                "4) Один конкретный процесс, который можно упростить с помощью AI, и ожидаемый эффект. Этот блок должен быть компактным: 2-4 предложения. Не перечисляй слишком много функций, интеграций и деталей реализации в одном письме. Пиши как живой человек, без конструкций вроде 'Предложение:' и без тяжёлого продуктового тона.\n"
                                ...
                                "'в разы', 'существенно повысить', 'революционно', 'быстро внедрим' и похожие. "
